const projects = [
  {
    ...
    slug: "petlinx",
    description:
      "Effortless Grooming Management · Petlinx is the Software with Choices · Real-time insights for smarter management and efficiency.",
    link: "https://petlinx.com/",
    images: [
      "/projects/screenshots/petlinx/1.png",
      "/projects/screenshots/petlinx/2.png",
    ],
    tags: ["Next.js", "Node.js", "PostgreSQL", "Firebase", "Google Auth", "AWS S3"],
    contributions: [
  ...
  },
  {
    ...
    slug: "kiddie-kredit",
    description:
      "Kiddie Kredit: A Mobile App for Kids That Promotes Financial Literacy by Teaching Credit Scores Through Chores.",
    link: "https://apps.apple.com/us/app/kiddie-kredit/id1440358106",
    images: [
    ...
    tags: ["React Native", "Node JS", "Android", "IOS", "Animation", "MongoDB", "AWS"],
  ...
  {
    title: "Intellibooks(Waiter App)",
    slug: "intellibooks",
    description:
      "IntelliBooks restaurant management system designed to streamline order taking and management for waiters. It allows waiters to quickly enter orders, potentially using QR codes for table service, and sends those orders directly to the kitchen. The app also integrates with other IntelliBooks features like inventory management and billing, contributing to a more efficient and accurate restaurant operation.",
    ...
    tags: ["React Native", "Node.js", "Express.js", "TypeScript"],
    contributions: [
   ...
   {
    title: "Gopher(Request App)",
    slug: "Request-App",
    description:
      `The Gopher Request app is a platform connecting users with local drivers, experts, and others for on-demand tasks and deliveries. Users can request services like delivery, yard work, moving, and more, while also having the flexibility to set their own prices or request bids from available "Gophers". `,
    link: "https://gophergo.io/",
    images: [
      "/projects/screenshots/gopher/gopher2.jpg",
      "/projects/screenshots/gopher/gopher2.jpg",
      "/projects/screenshots/gopher/gopher3.jpg",
    ],
    tags: ["React Native", "React Navigation", "Google Maps API", "Firebase Dynamic Links"],
    contributions: [
    ...
    displayImage: "/projects/screenshots/gopher/gopher2.jpg",
  },
  {
    title: "SWIFI",
    slug: "swifi",
